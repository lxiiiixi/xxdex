...
// import { ERC20Token, Currency, NativeCurrency, Token } from "@xxdex/sdk";
...
//     useUserAddedTokensByChainIds,
// } from "../state/user/hooks/useUserAddedTokens";
// import { useActiveChainId } from "./useActiveChainId";
import useNativeCurrency from "./useNativeCurrency";
import { UnsafeCurrency } from "@/types";
import { GELATO_NATIVE } from "@/config/constants";
import { Address, erc20Abi, zeroAddress } from "viem";
import { ChainId, ERC20Token, NativeCurrency, Token } from "@xxdex/sdk";
import { useMemo } from "react";
...
const memoizedTokenMap = memoize(
    ...
    (chainIds, tokenMap, userAddedTokenMap) => {
        ...
        if (!tokenMapId) {
            tokenMapId = uniqueId();
            if (tokenMapId) tokenMapCache.set(tokenMap, tokenMapId);
        }
